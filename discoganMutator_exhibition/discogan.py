...
class DiscoGAN():
    ...
    def train(self, epochs, batch_size=1, sample_interval=53):
    ...
    def sample_images(self, epoch, batch_i):
        os.makedirs(outputpath + '/%s' % self.dataset_name, exist_ok=True)
        r, c = 2, 3
...
#                 cnt += 1
#         # TODO folder
#         fig.savefig(outputpath + "/%s/%d_%d.png" % (self.dataset_name, epoch, batch_i))
#         plt.close()
# =============================================================================


# add this bit cause pyplot doesn't work in floyd 
        
# =============================================================================
#         
#         gen_imgs = 0.5 * gen_imgs + 0.5
#         cnt = 0
#         names = ['imgs_A', 'fake_B', 'reconstr_A', 'imgs_B', 'fake_A', 'reconstr_B']
#         for i in range(12):
#             name = names[i]
#             im = gen_imgs[cnt]
#             im = im * 255
#             im = im.astype(np.uint8)
#             cv2.imwrite (outputpath + "/%s/%d_%d_%s.png" % (self.dataset_name, epoch, batch_i, name), im)
#             #print (gen_imgs[cnt].shape)
#             #print (type(gen_imgs[cnt]))
#             cnt += 1
# =============================================================================
    ...
    def save_model(self):
        ...
        def save(model, model_name):
            model_path = outputpath +"/%s.json" % model_name
            weights_path = outputpath +"/%s_weights.hdf5" % model_name
        ...
        save(self.d_A, "discriminator_A")
        save(self.d_B, "discriminator_B")
        save(self.g_AB, "generator_AB")
        save(self.g_BA, "generator_BA")
        save (self.combined, "combinedDiscoGan")
